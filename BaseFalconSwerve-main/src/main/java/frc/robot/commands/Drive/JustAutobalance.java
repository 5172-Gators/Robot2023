...
public class JustAutobalance extends CommandBase {
    /** Creates a new TeleopElevatorTest. */
    private Swerve s_Swerve;

    private double startTime;

    public JustAutobalance(Swerve s_Swerve) {
    ...
    @Override
    public void execute() {
        s_Swerve.drive(new Translation2d(s_Swerve.GetRoll() / 40,0), 0, false, false);
    }
